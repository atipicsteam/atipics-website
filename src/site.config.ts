  ...
  nav: [
    {
      ...
      sub: [
        ...
        { label: "Réseau", href: "/agence#reseau" },
        { label: "Histoire", href: "/agence#histoire" },
      ],
    },
    {
      label: "Savoir Faire",
      href: "/savoir-faire",
      sub: [
        { label: "Artisanat", href: "/savoir-faire#artisanat" },
        { label: "Création", href: "/savoir-faire#creation" },
        { label: "Technique", href: "/savoir-faire#technique" },
      ],
    },
    {
      label: "Village",
